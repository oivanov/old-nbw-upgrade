 ...
 * @group statistics
 */
class DownloadStatisticsLoggingTest extends BrowserTestBase {
   ...
   * @var array
   */
  protected static $modules = ['node', 'download_statistics', 'block', 'locale'];
  ...
  protected function setUp(): void {
    ...
    // Clear the logs.
    db_truncate('download_statistics');
