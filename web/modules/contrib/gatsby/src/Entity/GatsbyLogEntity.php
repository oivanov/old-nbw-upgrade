...
namespace Drupal\gatsby\Entity;
 ...
 *     "list_builder" = "Drupal\gatsby\GatsbyLogEntityListBuilder",
 *     "views_data" = "Drupal\gatsby\Entity\GatsbyLogEntityViewsData",
 *     "access" = "Drupal\gatsby\GatsbyLogEntityAccessControlHandler",
 *   },
...
class GatsbyLogEntity extends ContentEntityBase implements GatsbyLogEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['preview'] = BaseFieldDefinition::create('boolean')
      ->setLabel(t('Preview'))
      ->setDescription(
